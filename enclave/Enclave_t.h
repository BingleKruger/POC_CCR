...
sgx_status_t ccr_poc(void);
sgx_status_t lending_profiles(const uint8_t* some_string_postal, size_t len_postal, const uint8_t* some_string_term, size_t len_term);
sgx_status_t credit_health(void);
sgx_status_t simple_ols_eg(void);
sgx_status_t multiple_ols_eg(void);
sgx_status_t time_series_eg(void);
sgx_status_t panel_data_eg(void);
sgx_status_t seal_sgxdata_eg(void);
sgx_status_t seal_sgxfile_eg(void);
sgx_status_t unseal_sgxfile_eg(void);
sgx_status_t seal_sgxfile_ccr(void);
